...
class PaymentServiceImplTest {
    ...
    @Test
    void refund_shouldSucceed_whenPaymentIsSuccess() {
    ...
    @Test
    void refund_shouldThrow_whenPaymentIsNotSuccess() {
        Payment payment = Payment.builder()
                .id(2L)
                .orderId(2L)
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() -> serviceWith(false).refund(2L))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("Chỉ hoàn tiền được giao dịch SUCCESS");
    }
}
